                ...
                {categories.map((category) => (
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8">
                            <h3 className="font-playfair text-3xl font-bold text-white mb-2 translate-y-2 transition-transform duration-300 group-hover:translate-y-0 text-shadow-md">
                                {category.name}
                            </h3>
                            <p className="text-white/90 text-lg translate-y-2 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 font-medium">
                                {category.count}
                            </p>
                        </div>
                    </Link>
